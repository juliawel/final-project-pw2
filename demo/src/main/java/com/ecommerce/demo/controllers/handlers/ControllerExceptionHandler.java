package com.ecommerce.demo.controllers.handlers;
...
import com.ecommerce.demo.dtos.CustomError;
import com.ecommerce.demo.dtos.ValidantionError;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValid(MethodArgumentNotValidException e,
        ...
        ValidantionError err = new ValidantionError(Instant.now(), status.value(), e.getMessage(),
